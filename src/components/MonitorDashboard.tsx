  ...
  return (
    ...
    >
            ...
            <div>
              <div className="flex items-center space-x-2">
                <h1 className="text-lg sm:text-xl font-black tracking-tight flex items-center space-x-2">
                  <span>2-Sektor Situatsion Monitoring Ekranı</span>
                </h1>
              ...
              <div className="flex items-center justify-between mb-1">
                ...
                <button
                  onClick={() =>
                    setSelectedCategoryModal({
                      type: 'mahallas',
                      title: '2-Sektor Barcha 12 ta Mahalla Reytingi & Murojaatlar Taqsimoti',
                    })
                  }
            ...
            <div className={`mt-5 pt-3 border-t text-[11px] ${isDark ? 'border-slate-800 text-slate-500' : 'border-slate-100 text-slate-400'} flex items-center justify-between`}>
              <button
                onClick={() =>
                  setSelectedCategoryModal({
                    type: 'mahallas',
                    title: '2-Sektor Barcha 12 ta Mahalla Kesimida Tahlil',
                  })
                }
              ...
              <span className="font-mono text-indigo-400 font-extrabold">2-Sektor</span>
            </div>
          </div>
      ...
      <footer className={`mt-10 py-5 border-t text-xs text-center ${isDark ? 'bg-slate-950 border-slate-800/80 text-slate-500' : 'bg-white border-slate-200 text-slate-500'}`}>
        <p>© 2026 Paxtachi Tumani 2-Sektor • Situatsion Boshqaruv & Live Monitoring Tizimi (Katta Monitor / TV Rejimi)</p>
      </footer>
