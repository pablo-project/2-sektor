...
export const MahallaYettiligiSection: React.FC<MahallaYettiligiSectionProps> = ({
  ...
  const handleSeedAll = async () => {
    if (!window.confirm("2-Sektorning barcha 12 ta mahallasiga 'Mahalla Yettiligi'ning namunaviy asosiy vazifalarini biriktirishni tasdiqlaysizmi?")) {
      return;
    }
    setIsSeeding(true);
    try {
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          <div className="space-y-2 max-w-2xl">
            <div className="inline-flex items-center space-x-2 px-3 py-1 bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 rounded-full text-xs font-black">
              ...
              <span>2-Sektor • 12 TA MAHALLA YETTILIGI</span>
            </div>
            <h2 className="text-2xl sm:text-3xl font-black text-white tracking-tight">
              Mahalla Yettiligi Boshqaruv & Ijro Paneli
            </h2>
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              Paxtachi tumani 2-Sektordagi 12 ta mahallada hokim yordamchisi, yoshlar yetakchisi, xotin-qizlar faoli, profilaktika inspektori, soliqchi va ijtimoiy xodimlar faoliyati bo‘yicha topshiriqlar, oflayn o‘rganish xulosalari hamda tashkilotlar tomonidan onlayn tasdiqlash monitoringi.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-xs">
            ...
            <div className="flex items-center space-x-2 w-full sm:w-auto">
              ...
              >
                ...
                <option value="1">2-Sektor hududidagi MFYlar</option>
              </select>
            </div>
          </div>
